...
def build_quality_gate_contract(*, bilingual: bool = False) -> dict:
    ...
    warning_checks = [
        ...
        {
            "id": "chunk_seam_duplication",
            "severity": "warning",
            "metric": "chunk_seam_warning_count",
            "expected_value": 0,
        },
        {
            "id": "header_fragment_balance",
            "severity": "warning",
            "metric": "header_density",
            "max_ratio": 0.6,
            "min_sections": 4,
            "max_avg_chars_per_section": 220,
        },
        {
            "id": "cjk_spacing_anomaly",
            "severity": "warning",
            "metric": "cjk_space_ratio",
            "applies_when": "cjk_readability_applicable",
            "max_ratio": 0.01,
        },
        {
            "id": "fragment_paragraph_ratio",
            "severity": "warning",
            "metric": "short_paragraph_ratio",
            "applies_when": "cjk_readability_applicable",
            "max_ratio": 0.45,
            "min_short_paragraphs": 4,
        },
        {
            "id": "duplicate_ngram_ratio",
            "severity": "warning",
            "metric": "duplicate_ngram_ratio",
            "applies_when": "cjk_readability_applicable",
            "max_ratio": 0.06,
            "min_duplicate_ngrams": 4,
        },
        {
